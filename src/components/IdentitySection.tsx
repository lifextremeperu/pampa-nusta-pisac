        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            ...
            <div className="relative z-10 p-8 md:p-10 flex flex-col h-full justify-end">
              ...
              <h3 className="font-sans text-2xl font-black tracking-widest uppercase text-white mb-4 drop-shadow-md">{t('identity.who')}</h3>
          ...
          >
            ...
            <div className="relative z-10 p-8 md:p-10 flex flex-col h-full justify-end">
              ...
              <h3 className="font-sans text-2xl font-black tracking-widest uppercase text-white mb-4 drop-shadow-md">{t('identity.mission')}</h3>
              <p className="text-white/90 leading-relaxed font-medium text-sm md:text-base">
              {t('identity.mission_desc')}
            </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="relative z-10 p-8 md:p-10 flex flex-col h-full justify-end">
              ...
              <h3 className="font-sans text-2xl font-black tracking-widest uppercase text-white mb-4 drop-shadow-md">{t('identity.vision')}</h3>
              <p className="text-white/90 leading-relaxed font-medium text-sm md:text-base">
                {t('identity.vision_desc')}
              </p>
            </div>
          </motion.div>
        </div>
